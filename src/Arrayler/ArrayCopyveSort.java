...
public class ArrayCopyveSort {
    ...
    public static void main(String[] args) {
        ...
        /*if (a1 == a2) {
            ...
            System.out.println("Eşit Değiller"); // içindeki değerler aynı olsa bile farklı yeri gösteriyorlar
        }*/

        if (Arrays.equals(a1,a2)) { // equals, 2 array'in içeriği aynıysa true sonucunu veriyor.
            System.out.println("Eşitler");
        }
        else {
