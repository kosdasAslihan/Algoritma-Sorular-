...
public class Main {
    public static void main(String[] args) {
        ...
        Calisan Sinifi şeklinde bir üst sınıf

        Calisan Sinifindan Tureyen Yazilimci adında bir alt sınıf
        Calisan Sinifindan Tureyen Yonetici adında bir alt sınıf
         */
        ...
        while (true) {
            ...
            if (islem.equals("q")) {
                ...
                Yazilimci yazilimci = new Yazilimci("Ali", "Veli", 567, "Python,C,Java");
                ...
                Yonetici yonetici = new Yonetici("Ayşe", "Yılmaz", 123, 10);
