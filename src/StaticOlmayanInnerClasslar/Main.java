...
public class Main {
    public static void main(String[] args) {
        ...
        Matematik.Factorial factorial = new Matematik().new Factorial(); //ilk önce Matematik oluşturuldu sonra içindeki
                                                                         //faktöriyel oluşturuldu.
        Matematik.Asal asal = new Matematik().new Asal(); //Static olmayan Inner Classların obje oluşturulması bu şekilde.
