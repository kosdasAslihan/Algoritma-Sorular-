...
public class HashMapLinkedHashMapTreeMap {
    ...
    public static void mapYazdir(Map<Integer,String> map) {
        ...
        //System.out.println(map.keySet()); //ekrana sadece anahtarlar basılmış oldu.
        ...
        Collection<String> values = map.values(); //değerlerin olduğu collection objesi döner.
